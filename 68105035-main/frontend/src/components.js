...
import { Text, Box, Sphere, Plane, OrbitControls, Environment, Float, Center } from '@react-three/drei';
import { motion, useScroll, useTransform } from 'framer-motion';
import * as THREE from 'three';

// 3D Aircraft Component
const Aircraft3D = ({ position = [0, 0, 0], rotation = [0, 0, 0], scale = 1 }) => {
    ...
    >
      <Canvas camera={{ position: [0, 0, 10], fov: 60 }}>
        ...
        <Float speed={2} rotationIntensity={0.1} floatIntensity={0.5}>
          <Aircraft3D position={[0, 0, 0]} scale={0.5} />
        </Float>
      ...
      <div className="hero-canvas-container">
        <Canvas camera={{ position: [0, 0, 8], fov: 60 }}>
          ...
          <Float speed={1} rotationIntensity={0.2} floatIntensity={0.3}>
            <Aircraft3D position={[3, 0, 0]} scale={0.8} />
          </Float>
        ...
        >
          <Canvas camera={{ position: [0, 0, 5], fov: 60 }}>
            ...
            <Float speed={1.5} rotationIntensity={0.1} floatIntensity={0.2}>
              <Aircraft3D position={[0, 0, 0]} scale={0.6} />
            </Float>
